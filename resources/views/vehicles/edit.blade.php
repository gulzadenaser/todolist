...
<div class="container">
<div class="card">
  <div class="card-header"><h3>Update Vehicle</h3></div>
     <div class="card-body">  
        @if ($errors->any())
        ...
        @endif   
     {{ Form::model($vehicle, array('route' => array('vehicle.update', $vehicle->id), 'method' => 'POST','class' => 'form validity')) }}
        {{ method_field('PATCH') }}
       <div class="row">
        ...
        <div class="form-group">
          <label class="font-normal required"><strong>Color</strong></label>
            <div class="input-group date">
                <input type="text" class="form-control input-sm" value="{{ $vehicle->color }}" id="color" name="color" required>
            </div>
        </div>
        <div class="form-group">
        <label class="font-normal required"><strong>Model</strong></label>
            <div class="input-group date">
                <input type="text" class="form-control input-sm" value="{{ $vehicle->model }}" id="model" name="model" required>
            </div>
        </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group date">
                <input type="text" class="form-control input-sm" value="{{ $vehicle->make }}" id="make" name="make" required>
            </div>
        </div>
        <div class="form-group">
            <label class="font-normal required"><strong>Registration Number</strong></label>
            <div class="input-group date">
                <input type="text" class="form-control input-sm" value="{{ $vehicle->registration_no }}" id="registration_no" name="registration_no" required>
            </div>
        </div>
